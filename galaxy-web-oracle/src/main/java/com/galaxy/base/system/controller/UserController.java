...
import com.galaxy.base.common.config.Constant;
...
import com.galaxy.base.common.utils.PageUtils;
...
import com.galaxy.base.system.domain.RoleDO;
import com.galaxy.base.system.domain.UserDO;
import com.galaxy.base.system.service.RoleService;
import com.galaxy.base.system.service.UserService;
...
public class UserController extends BaseController {
	...
	R save(UserDO user) {
		...
		user.setPassword(MyEncryptUtils.encrypt(user.getUsername(), user.getPassword()));
	...
	R resetPwd(UserDO user) {
		...
		user.setPassword(MyEncryptUtils.encrypt(userService.get(user.getUserId()).getUsername(), user.getPassword()));
